...
public class ProductController {
	...
	public ProductController() {
		leds.addAll(List.of(new Led("X75L", 45000.98), new Led("X80L", 51000.98), new Led("X85L", 45000.98),
				new Led("X90L", 71000.98), new Led("X95L", 86000.98), new Led("XAOLED", 145000.98)
